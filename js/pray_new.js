document.addEventListener('DOMContentLoaded', function() {
    ...
    foregroundImage.addEventListener('click', function(e) {
        ...
        if (distance <= 200) {
            ...
            console.log('当前签文:', randomFortune);
            ...
            fortuneVideo.load(); // 确保视频加载
            fortuneVideo.classList.add('visible'); // 使用 CSS 类显示视频
            fortuneVideo.loop = true; // 设置循环播放
            
            // 使用Promise确保视频可以播放
            const playPromise = fortuneVideo.play();
    ...
    interpretBtn.addEventListener('click', function() {
        ...
        gsap.to(image7, {
            ...
            onComplete: function() {
                ...
                image54.style.transform = 'translate(-50%, -50%) rotateY(-90deg) scale(1.3)'; // 添加放大效果
                gsap.to(image54, {
                    rotationY: 0,
                    opacity: 1,
                    scale: 1.3, // 保持放大效果
